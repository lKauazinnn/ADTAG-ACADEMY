...
const musicModules = [
  {
    ...
    description: 'Fundamentos de teoria musical, escalas, acordes, progressões harmônicas e como aplicar na prática.',
    aulas: 22,
    horas: '5h 30min',
    color: '#FF9A00',
    dark: '#5c3600',
    featured: true,
    topicos: ['Escalas e modos', 'Harmonia funcional', 'Progressões de acordes', 'Cifras e partituras'],
  },
  {
    abbr: 'PR',
    name: 'Produção',
    title: 'Produção Musical — DAW & Beats',
    description: 'Criação de beats, arranjos, mixagem básica e como produzir músicas do zero no computador.',
    aulas: 18,
    horas: '4h 45min',
    color: '#9333ea',
    dark: '#3b1060',
    featured: false,
    topicos: ['DAW do zero', 'Criação de beats', 'Arranjo e composição', 'Mixagem básica'],
  },
  {
    abbr: 'MX',
    name: 'Mixagem',
    title: 'Mixagem & Masterização',
    description: 'Técnicas profissionais de mixagem, uso de EQ, compressores, reverb e masterização para streaming.',
    aulas: 16,
    horas: '4h 00min',
    color: '#31C5F4',
    dark: '#0b4458',
    featured: false,
    topicos: ['EQ e dinâmica', 'Compressão', 'Efeitos e reverb', 'Masterização'],
  },
  {
    abbr: 'VZ',
    name: 'Voz',
    title: 'Técnica Vocal & Performance',
    description: 'Desenvolvimento vocal, respiração, afinação, expressividade e como se apresentar no palco.',
    aulas: 14,
    horas: '3h 20min',
    color: '#E1306C',
    dark: '#5c0e27',
    featured: false,
    topicos: ['Respiração', 'Afinação e dicção', 'Expressividade', 'Performance ao vivo'],
  },
  {
    abbr: 'RD',
    name: 'Release',
    title: 'Lançamento & Distribuição Digital',
    description: 'Como lançar sua música no Spotify, Deezer, YouTube Music e maximizar seus streams e royalties.',
    aulas: 10,
    horas: '2h 30min',
    color: '#1DB954',
    dark: '#0a3d1c',
    featured: false,
    topicos: ['Distribuidoras digitais', 'Estratégia de lançamento', 'Playlists', 'Royalties'],
  },
  {
    abbr: 'MK',
    name: 'Marketing',
    title: 'Marketing para Artistas',
    description: 'Construção de marca pessoal, presença digital, press kit, EPK e como divulgar sua música.',
    aulas: 12,
    horas: '3h 00min',
    color: '#FF3333',
    dark: '#5c0000',
    featured: false,
    topicos: ['Marca pessoal', 'EPK profissional', 'Redes sociais para artistas', 'Parcerias e contatos'],
  },
];
  ...
  return (
    <div className="min-h-screen" style={{ background: '#050509' }}>
      ...
      <div className="pointer-events-none fixed inset-0 z-0" style={{ overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 110% 70% at 85% -10%, rgba(255,154,0,0.2), transparent 55%), radial-gradient(ellipse 90% 80% at -10% 65%, rgba(147,51,234,0.2), transparent 55%), radial-gradient(ellipse 70% 60% at 50% 110%, rgba(49,197,244,0.1), transparent 55%)' }} />
        <div style={{ position: 'absolute', top: '-15%', right: '-10%', width: 900, height: 900, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,154,0,0.16) 0%, transparent 65%)', filter: 'blur(40px)' }} />
        ...
        <div style={{ position: 'absolute', top: '40%', right: '10%', width: 600, height: 600, borderRadius: '50%', background: 'radial-gradient(circle, rgba(49,197,244,0.08) 0%, transparent 65%)', filter: 'blur(60px)' }} />
        <div style={{
      ...
      <div className="relative z-10 overflow-hidden" style={{ background: 'rgba(5,5,12,0.55)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute" style={{ inset: 0, background: 'radial-gradient(ellipse 110% 90% at 95% 10%, rgba(255,154,0,0.28), transparent 55%)' }} />
          ...
          <div className="absolute" style={{ inset: 0, background: 'radial-gradient(ellipse 60% 60% at 55% 120%, rgba(49,197,244,0.1), transparent 55%)' }} />
          <div className="absolute bottom-0 left-0 right-0" style={{ height: 1, background: 'linear-gradient(90deg, transparent, rgba(255,154,0,0.5), rgba(147,51,234,0.5), rgba(49,197,244,0.4), transparent)' }} />
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10">
            ...
            <div>
              <div className="flex items-center gap-2 mb-5">
                <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ background: '#FF9A00', boxShadow: '0 0 10px #FF9A00, 0 0 24px rgba(255,154,0,0.5)' }} />
                <span className="text-[10px] font-bold uppercase tracking-[0.3em]" style={{ color: '#FF9A00' }}>Creative Studio · ADTAG</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #FF9A00, #9333ea)', color: '#fff', boxShadow: '0 4px 20px rgba(255,154,0,0.35)' }}
                >
                ...
                <span className="text-[10px] px-3 py-1.5 rounded-full font-semibold uppercase tracking-wider" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', color: '#9494b8' }}>
                  {musicModules.length} módulos · {totalAulas} aulas
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              {[
                { val: musicModules.length, label: 'módulos',  color: '#fafafa' },
                { val: totalAulas,          label: 'aulas',    color: '#FF9A00' },
                { val: '23h+',              label: 'conteúdo', color: '#9333ea' },
              ].map(s => (
      ...
      <div className="relative z-10">
        <div className="pointer-events-none absolute inset-0 overflow-hidden" style={{ zIndex: 0 }}>
          <div style={{ position: 'absolute', top: '-10%', left: '-10%', width: 700, height: 700, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,154,0,0.15) 0%, transparent 60%)', filter: 'blur(80px)' }} />
          ...
          <div style={{ position: 'absolute', bottom: '0%', left: '20%', width: 800, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(49,197,244,0.08) 0%, transparent 60%)', filter: 'blur(80px)' }} />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-10">
          ...
          <div className="mb-10 animate-fade-in-up" style={{ animationDelay: '0.05s' }}>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-0.5 h-5 rounded-full" style={{ background: 'linear-gradient(180deg, #FF9A00, #9333ea)' }} />
              <span className="text-[11px] font-bold uppercase tracking-[0.18em]" style={{ color: '#fafafa' }}>Módulo em Destaque</span>
            </div>

            <div
              className="rounded-2xl overflow-hidden relative cursor-pointer"
              style={{ background: 'rgba(14,14,22,0.9)', border: '1px solid rgba(255,154,0,0.3)', boxShadow: '0 8px 48px rgba(255,154,0,0.15)', transition: 'transform 0.4s cubic-bezier(0.22,1,0.36,1), box-shadow 0.4s ease' }}
              onClick={() => {}}
              onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.transform = 'translateY(-3px)'; (e.currentTarget as HTMLDivElement).style.boxShadow = '0 20px 60px rgba(255,154,0,0.25)'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLDivElement).style.transform = 'translateY(0)'; (e.currentTarget as HTMLDivElement).style.boxShadow = '0 8px 48px rgba(255,154,0,0.15)'; }}
            >
              <div style={{ height: 3, background: 'linear-gradient(90deg, #FF9A00, #9333ea, #31C5F4)' }} />
          ...
          <div className="flex items-center justify-between mb-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <span className="text-[11px] px-3 py-1 rounded-full font-medium" style={{ color: '#9494b8', background: 'rgba(18,18,26,0.7)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.07)' }}>
              {musicModules.length} módulos disponíveis
            </span>
          </div>

          {/* Grid de cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {musicModules.map((mod, index) => (
              <div
                key={mod.abbr}
          ...
          <div className="mt-10 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <div className="rounded-2xl p-7 relative overflow-hidden" style={{ background: 'rgba(14,14,22,0.8)', border: '1px solid rgba(255,255,255,0.07)' }}>
              <div className="pointer-events-none absolute inset-0" style={{ background: 'radial-gradient(ellipse 80% 100% at 100% 50%, rgba(255,154,0,0.12), transparent 70%), radial-gradient(ellipse 60% 100% at 0% 50%, rgba(147,51,234,0.1), transparent 70%)' }} />
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-5">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: '#FF9A00' }}>ADTAG · Creative Studio</p>
                  <h3 className="text-lg font-black" style={{ color: '#fafafa', letterSpacing: '-0.02em' }}>
                    Eleve sua carreira musical ao próximo nível
                  </h3>
                ...
                <div className="flex items-center gap-3">
                  {[{ abbr: 'TC', c: '#FF9A00' }, { abbr: 'PR', c: '#9333ea' }, { abbr: 'MX', c: '#31C5F4' }, { abbr: 'VZ', c: '#E1306C' }].map(t => (
                  ...
                  <button
                    ...
                    style={{ background: 'linear-gradient(135deg, #FF9A00, #9333ea)', color: '#fff', boxShadow: '0 4px 20px rgba(255,154,0,0.3)' }}
                    onClick={() => {}}
                  >
                    Começar agora
